    ...
    return (
        <div className="auth">
            ...
            <div className="auth-card">
                ...
                <p className="muted">
                    Secure storage for your files, anywhere.
                </p>
        ...
        <div className="app">
            ...
            {share && (
                ...
                >
                    ...
                    <p className="muted">
                        Invite another CloudDrive user.
                    </p>
                    ...
                    <>
                        ...
                        <button
                            onClick={() =>
                                ...
                                `${api.defaults.baseURL}/files/${f.id}/download`
                            }
                        >
                            <Download size={16} />
                        </button>
